...
(3, 'Science', 'Active'),
(4, 'History', 'Active'),
(5, 'Physical Education', 'Active'),
(6, 'Arts', 'Active'),
(7, 'Music', 'Active'),
(8, 'Computer Sciences', 'Active'),
(9, 'Languages', 'Active'),
(10, 'Social Studies', 'Active'),
(11, 'Human resource Management', 'Inactive'),
(12, 'Hero depart', 'Inactive'),
(13, 'Arts gallery', 'Active');
...
--
-- Dumping data for table `employees_certificate`
--

INSERT INTO `employees_certificate` (`certficate_id`, `request_id`, `employee`, `training`, `approved_by`, `approve_date`) VALUES
(2, 1, 10, 2, 2, '2023-09-16 16:32:37');
...
--
-- Dumping data for table `employees_request_certificates`
--

INSERT INTO `employees_request_certificates` (`request_id`, `employee`, `training`, `request_date`, `request_status`) VALUES
(1, 10, 2, '2023-09-16 14:05:05', 'Approved');
...
(119, 10, 2, 11, 18, 'I think i don\'t know', 5, 'Markked', '2023-09-12 09:09:56'),
(120, 10, 2, 11, 19, 'Yes i get it', 3, 'Markked', '2023-09-12 09:09:56'),
(121, 10, 2, 11, 20, 'Ok if it\'s cool', 2, 'Markked', '2023-09-12 09:09:57'),
...
(126, 10, 2, 15, 25, 'ewe', 428, 'Markked', '2023-09-15 18:12:00'),
(127, 10, 2, 15, 26, 'ewe\r\n', 39, 'Markked', '2023-09-15 18:12:00'),
(128, 10, 2, 14, 27, 'ihiu iuuijui', 0, 'Pending', '2023-09-15 18:12:18'),
(129, 10, 2, 14, 28, 'wsqjuiewni ni ndfi nij n fh jck cx jkzx klz lk kl', 0, 'Pending', '2023-09-15 18:12:18'),
(130, 10, 2, 14, 29, 'ck skwldj wdl dj nl\r\n', 0, 'Pending', '2023-09-15 18:12:18'),
(131, 10, 2, 17, 32, 'sdfgdf', 0, 'Pending', '2023-09-16 12:16:34'),
(132, 10, 2, 17, 33, 'EQIDJHCUI', 0, 'Pending', '2023-09-16 12:16:34'),
(133, 10, 2, 17, 34, 'HUIHDQWEUIDHUI', 0, 'Pending', '2023-09-16 12:16:34'),
(134, 10, 2, 16, 30, 'SDOIVJIOJ', 3000, 'Markked', '2023-09-16 12:16:41'),
(135, 10, 2, 16, 31, 'DNOCIDONCION', 4454, 'Markked', '2023-09-16 12:16:42');
...
(14, 10, 11, 6, 10, '2023-09-12 21:59:33', 'Marked'),
(15, 9, 11, 0, 0, '2023-09-13 09:23:30', 'Marked'),
(17, 15, 11, 0, 0, '2023-09-13 09:32:44', 'Marked'),
(20, 15, 13, 22, 26, '2023-09-13 12:44:40', 'Marked'),
(22, 10, 13, 0, 26, '2023-09-15 17:43:59', 'Marked'),
(23, 9, 13, 0, 26, '2023-09-15 17:45:30', 'Marked'),
(24, 10, 15, 469, 472, '2023-09-15 18:13:29', 'Marked'),
(25, 10, 15, 38, 472, '2023-09-15 18:13:40', 'Marked'),
(26, 10, 15, 19, 472, '2023-09-15 18:13:50', 'Marked'),
(27, 10, 15, 19, 472, '2023-09-15 18:16:12', 'Marked'),
(28, 15, 15, 0, 472, '2023-09-15 18:18:02', 'Marked'),
(29, 9, 15, 0, 472, '2023-09-16 08:32:31', 'Marked'),
(30, 10, 15, 472, 472, '2023-09-16 08:32:57', 'Marked'),
(31, 10, 15, 467, 472, '2023-09-16 08:33:30', 'Marked'),
(32, 10, 11, 10, 10, '2023-09-16 12:19:52', 'Marked'),
(33, 10, 16, 7454, 7454, '2023-09-16 12:20:29', 'Marked'),
(34, 9, 16, 0, 7454, '2023-09-16 12:20:42', 'Marked');
...
(28, 10, 2, 9, 'Completed', '2023-09-15 17:28:33'),
(29, 10, 2, 8, 'Completed', '2023-09-15 17:28:42'),
(30, 10, 2, 7, 'Completed', '2023-09-15 17:28:46'),
(31, 10, 2, 10, 'Completed', '2023-09-15 17:28:49'),
(32, 10, 2, 6, 'Completed', '2023-09-15 17:28:51'),
(33, 10, 2, 5, 'Completed', '2023-09-15 17:28:55'),
(34, 10, 2, 11, 'Completed', '2023-09-15 17:29:04');
...
(11, 'reuire', 'wfeuijui', 'weifjewi@dfder.er', 788923011, 'Offline');
...
(14, 2, 'test last test', '2024-10-10 18:08', 3, 'Completed'),
(15, 2, 'last one', '2023-09-21 18:09', 2, 'Completed'),
(16, 2, 'dsfsrvd', '2024-11-11 08:42', 2, 'Completed'),
(17, 2, 'derthjnbvc', '0034-03-31 14:23', 3, 'Completed');
...
(25, '2023-09-15 18:08:27', 'sud', 'qoifjq', 433, 15, 2),
(26, '2023-09-15 18:08:28', '2fiweffuiuih', 'woidj djo f jdoijvi iodm odm om', 39, 15, 2),
(27, '2023-09-15 18:08:47', 'fiovjioj', 'iojdiojioj', 34, 14, 2),
(28, '2023-09-15 18:08:47', 'efiojfuiwj', 'jjwefiosjcioj', 340598, 14, 2),
(29, '2023-09-15 18:08:47', 'vrfiodsjio', 'rfioj\\r\\n', 23, 14, 2),
(30, '2023-09-16 08:38:50', 'dsfgv', 'rervdf', 3000, 16, 2),
(31, '2023-09-16 08:38:50', 'dewdcef', 'efeewe', 4454, 16, 2),
(32, '2023-09-16 08:39:16', 'dscsdcdc', 'FDVDFCFD', 2222222, 17, 2),
(33, '2023-09-16 08:39:16', 'efrfvfvdfvfdv', 'wdfe', 234444, 17, 2),
(34, '2023-09-16 08:39:16', 'ewfedsdf', 'eresfrsfrf', 1233223, 17, 2);
...
(3, 2, 15, '2023-09-15 18:13:08', 1),
(4, 2, 14, '2023-09-15 18:13:10', 1),
(5, 2, 17, '2023-09-16 12:17:10', 1),
(6, 2, 16, '2023-09-16 12:17:11', 1);
...
(2, 'Dealing with just the two of you', 'This is the trainings which will be cool when it starts with the after days and it can be best if we create a good contstructing plan. And i think it will be good This is the trainings which will be cool when it starts with the after days and it can be best if we create a good contstructing plan. And i think it will be good This is the trainings which will be cool when it starts with the after days and it can be best if we create a good contstructing plan. And i think it will be good', '2023-08-06', '2023-08-25', 'pexels-rdne-stock-project-7948054.jpg', 8, 'Progress'),
...
(16, 'sdioj oijbiofjbiodjbo iodfmfio', 'ewifojwerfioj ioo  od dfnmo ', '2023-09-22', '2023-10-06', 'WhatsApp Image 2023-09-07 at 20.23.32.jpg', 5, 'Waiting');
...
(9, 3, 11, '4869a101557665621ba8aace393559b1', 'Progress');
...
(16, '322378232874', 'Not set Yet', 'fwdio', 'fioejwiocjo', 'iojwefifjcweio@gdmd.com', 549438492, 'Not set Yet', 'Employee', 8, 'No account yet'),
(17, '1344948334494843', 'Not set Yet', 'Kwi', 'eiwrof', 'eijweiofjo32093i2@fg.dd', 2147483647, 'Not set Yet', 'Employee', 8, 'No account yet'),
(18, '1129833874747333', 'Not set Yet', 'dsfuisdjiojio', 'ieoj', 'iwejiofjweioj@FDVF.REF', 722893974, 'Not set Yet', 'Employee', 8, 'No account yet');
