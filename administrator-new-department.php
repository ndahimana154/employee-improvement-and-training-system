        ...
        <div class="row p-2">
            ...
            <div class="col-md-8">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <?php
                        if (isset($_POST['save_dep'])) {
                            ...
                            if (mysqli_num_rows($check_deprt_exists) > 0) {
                                ...
                                // Save department
                                $save_depart = mysqli_query($server,"INSERT into departments
                                    VALUES(null,'$deprt_name','Active')
                                ");
                                if(!$save_depart) {
                                    ?>
                    ...
                    <p>
                        <input type="text" name="dep_name" placeholder="Type..." class="form-control"  required>
                    </p>
                    <p>
